...
def validate_args(args, defaults={}):
    ...
    if args.encoder_tensor_model_parallel_size > 0:
        ...
        ), "encoder_pipeline_model_parallel_size must be defined."
...
def _add_moe_args(parser):
    ...
    group.add_argument(
        ...
        type=int,
        default=1,
        help='Number of pipeline degree for MoE. The default is 1.',
    )
    group.add_argument(
        '--bp-pipeline-degree',
        type=int,
        default=1,
        help='Number of bp pipeline degree for MoE. The default is 1.',
    )
    group.add_argument(
        '--moe-router-topk',
        type=int,
